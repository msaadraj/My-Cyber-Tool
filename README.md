...
<ul>
  <li>🎨 Colorful UI using ANSI escape codes</li>
  <li>📂 Inventory stored and updated in a CSV file</li>
  <li>🔁 Smooth loading animations during operations</li>
  <li>❌ Error handling for invalid and duplicate inputs</li>
  <li>🧩 Modular code structure (input validation, animation, design, logic)</li>
</ul>

<h3>🚪 Exit Option:</h3>
<p>
  Allows the user to safely exit the system using a controlled CLI prompt.
</p>
...
<ul>
  ...
  <li><strong>Core Concepts Used:</strong>
    <ul>
      ...
      <li>Modular Class & Method Design (Designing, Validation, Animation, Service layers)</li>
      <li>File Handling with CSV for inventory storage</li>
      <li>Stream API and Optional for searching and filtering data</li>
      <li>ANSI Escape Codes for colored terminal UI</li>
      <li>Exception Handling for user input and I/O operations</li>
    </ul>
  </li>
</ul>
